...
class CWeald_Curio_Luggage : public CInteractionObj
{
public:
	CWeald_Curio_Luggage(LPDIRECT3DDEVICE9 pGraphicDev);
	CWeald_Curio_Luggage(const CWeald_Curio_Luggage& rhs);
	virtual ~CWeald_Curio_Luggage();
