...
class CWeald_Curio_Chest : public CInteractionObj
{
public:
	CWeald_Curio_Chest(LPDIRECT3DDEVICE9 pGraphicDev);
	CWeald_Curio_Chest(const CWeald_Curio_Chest& rhs);
	virtual ~CWeald_Curio_Chest();
