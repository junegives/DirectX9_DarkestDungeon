...
class CWeald_Curio_Spider : public CInteractionObj
{
public:
	CWeald_Curio_Spider(LPDIRECT3DDEVICE9 pGraphicDev);
	CWeald_Curio_Spider(const CWeald_Curio_Spider& rhs);
	virtual ~CWeald_Curio_Spider();
